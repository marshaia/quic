defmodule Quic.Accounts.AuthorToken do
  use Ecto.Schema
  import Ecto.Query
  alias Quic.Accounts.AuthorToken
  ...
  schema "authors_tokens" do
    ...
    belongs_to :author, Quic.Accounts.Author
  ...
  """
  def by_author_and_contexts_query(author, :all) do
    from t in AuthorToken, where: t.author_id == ^author.id
  end

  def by_author_and_contexts_query(author, [_ | _] = contexts) do
