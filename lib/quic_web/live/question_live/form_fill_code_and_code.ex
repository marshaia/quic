    ...
    <div>
      ...
      <%= if @type === :fill_the_code do %>
        ...
        <div class="flex items-center gap-2 mt-8 mb-2">
          ...
          <.tooltip tooltip_id={answers_id} class={"-left-32 w-[300px] -top-32"}>
            <p>Here you enter the correspondence between the <code>ids</code> defined above and the correct answers. Like so: </p>
            <p><code>id:int a</code></p>
          </.tooltip>
        </div>
      ...
      <div class="flex items-center gap-2 mt-8 mb-2">
        ...
        <.tooltip tooltip_id={test_file_id} class={"-left-16 w-[300px] -top-56"}>
          <p>Here you enter the code to test the Participant's submission.</p>
          <p>When using <b>C</b>, don't forget to define the function's header so that it uses the function defined by the Participant when compiled.</p>
          <p>When using <b>Python</b>, dont' forget to retrieve the test arguments using the library <code>argparse</code>.</p>
        </.tooltip>
      </div>
      ...
      <div class="flex items-center gap-2 mt-8 mb-2">
        ...
        <.tooltip tooltip_id={tests_id} class={"-left-12 w-[300px] -top-64"}>
          <p>Here you enter the tests to assess the code submitted by the Participants.</p>
          <p>Follow the syntax <code>input:output</code>. To insert multiple inputs, simply separate them with commas, like this: <code>1,2:3</code></p>
          <p>You can enter empty inputs or outputs by leaving them empty, like this <code>:4</code> or this <code>3,-1:</code></p>
          <p>Strings don't need (double) quotes: <code>hello:Hello World</code></p>
        </.tooltip>
      </div>
