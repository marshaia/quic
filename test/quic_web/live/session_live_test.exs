defmodule QuicWeb.SessionLiveTest do
  use QuicWeb.ConnCase

  import Phoenix.LiveViewTest
  import Quic.SessionsFixtures

  @create_attrs %{code: "some code", status: :live, type: :teacher_paced, start_date: "2024-03-07", end_date: "2024-03-07"}
  @update_attrs %{code: "some updated code", status: :closed, type: :student_paced, start_date: "2024-03-08", end_date: "2024-03-08"}
