defmodule QuicWeb.ConnCase do
  ...
  by setting `use QuicWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import QuicWeb.ConnCase
    end
  end

  setup tags do
    Quic.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_author(%{conn: conn}) do
    author = Quic.AccountsFixtures.author_fixture()
  ...
  def log_in_author(conn, author) do
    token = Quic.Accounts.generate_author_session_token(author)
